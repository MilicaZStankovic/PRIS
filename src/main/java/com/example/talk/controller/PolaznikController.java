...
public class PolaznikController {
	...
	public String prikazLekcije(HttpServletRequest request, HttpServletResponse response, Integer idLekcija) throws ServletException, IOException {
...
/*		if(fajl != null) {
	...
	public String prihvatiOdgovore(HttpServletRequest request, String opcije, String tekstOdg
		...
		for(Pitanje pit : pitanja) {
			...
			request.getSession().setAttribute("odgovoriT", odgovori);
	...
	public String prikazPolozenihKurseva(HttpServletRequest request) {
		...
		System.out.println(kursevi.size());
		System.out.println(polozeniTestovi.size());
		
		String poruka = null;
		
		if (kursevi == null)
			poruka = "Niste polozili ni jedan kurs!";

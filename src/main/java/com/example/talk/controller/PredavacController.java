...
public class PredavacController {
	...
	public String dodajLekcijuFajl(Model m, @ModelAttribute("lekcijaF") LekcijaFajl lekcijaFajl, HttpServletRequest request, String naslovF,
		...
		if(null!=file) {
			...
			//	l1.setNaslov(lekcijaFajl.getNaslov());
			//	l1.setTekst(lekcijaFajl.getTekst());
				l1.setNaslov(naslovF);
				l1.setTekst(tekstF);
				l1.setFajl(Files.readAllBytes(fileFile.toPath()));
			//	l1.setKur(lekcijaFajl.getKurs());
...
//					if((r1!=null && unetOdg1!=null) || (r2!=null  && unetOdg2!=null) || (r3!=null && unetOdg3!=null)) {
//						if (r1.getTekst().equals(unetOdg1.getOpcija1()) || r2.getTekst().equals(unetOdg2.getOpcija2()) || r3.getTekst().equals(unetOdg3.getOpcija3())) {
//							osvojeniPoeni+=poeniInt;
//						}
//					}
					if(r1!=null && unetOdg1!=null) {

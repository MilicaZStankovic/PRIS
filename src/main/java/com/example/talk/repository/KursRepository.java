...
public interface KursRepository extends JpaRepository<Kurs, Integer>{
	...
	@Query("select k from Kurs k where k.ocena like :ocena and k.datumOcene between :d1 and :d2")
	public List<Kurs> kurseviOcenaDatum(@Param("ocena")String ocena, @Param("d1") Date d1, @Param("d2") Date d2);
}

...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		<div class="container">
			<a class="navbar-brand" href="#">Skola jezika "Talk"</a>
								...
								<ul class="navbar-nav">
									...
									<li class="nav-item dropdown">
										...
										<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
											...
											<a class="dropdown-item" href="/Talk/najboljeOcenjeniKursevi.jsp">Najbolje ocenjeni kursevi</a>
									...
									<li class="nav-item dropdown">
										...
										<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
											...
											<a class="dropdown-item" href="/Talk/polaznikController/getSvaPitanja">Dodavanje resenja</a>
										</div>
									</li>
									<li class="nav-item">
